...
SET image_url = CASE
  ...
  WHEN lower(s.name) LIKE '%sr650%' AND lower(s.name) LIKE '%lenovo%' THEN '/static/products/lenovo-sr650-v3.jpg'
  ...
  WHEN c.code LIKE 'SW_%' THEN '/static/products/cisco-catalyst.jpg'
